document.addEventListener('DOMContentLoaded', function() {
					...
					<span aria-hidden=true class="pilot__container">
						<span class="pilot-bear">
							<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
								fill="none" viewBox="0 0 1448 938">
								<mask id="a" fill="#fff">
								...
								<path fill="#000" fill-rule="evenodd"
									...
									clip-rule="evenodd" />
								<path fill="url(#b)" fill-opacity=".4" fill-rule="evenodd"
									d="M709.7 164.481c-17.939 14.394-28.018 37.148-28.018 57.504h61.648c.087-13.669 11.194-24.723 24.883-24.723h18.56c13.689 0 24.796 11.054 24.883 24.723H873c0-20.356-10.078-43.11-28.018-57.504C827.043 150.086 802.711 142 777.341 142c-25.37 0-49.701 8.086-67.641 22.481Z"
									clip-rule="evenodd" />
								<circle cx="8.079" cy="8.079" r="8.079" fill="#000"
								...
								<path fill="#707070" stroke="#000" stroke-width="6"
									d="M687 370v16h183v-16zm0-54v16h183v-16z" />
								<path fill="#D9D9D9" stroke="#000" stroke-width="6"
									d="M795 370h-28v16h28zm76-69h-16v95h16zm-172 0h-16v95h16z" />
								<rect width="74.266" height="52" x="-3" y="3" fill="#AF7128" stroke="#000"
									stroke-width="6" rx="26" transform="matrix(-1 0 0 1 732 316)" />
								<path fill="#000"
								...
								<path fill="#D9D9D9" fill-rule="evenodd"
									...
									clip-rule="evenodd" />
								<path fill="url(#e)" fill-opacity=".4" fill-rule="evenodd"
									d="M1359.3 372.549H159.657v337.053H949.06l410.24-236.853v-100.2Z"
									clip-rule="evenodd" />
								...
								<path fill="url(#j)" fill-opacity=".2"
								...
								<defs>
									<linearGradient id="b" x1="682" x2="860" y1="205" y2="182"
										gradientUnits="userSpaceOnUse">
										<stop stop-color="#fff" />
										<stop offset=".375" stop-color="#fff" stop-opacity="0" />
									</linearGradient>
									<linearGradient id="c" x1="444" x2="643" y1="325" y2="321"
										gradientUnits="userSpaceOnUse">
										<stop stop-color="#fff" />
										<stop offset=".443" stop-color="#fff" stop-opacity="0" />
									</linearGradient>
									<linearGradient id="d" x1="0" x2="119.743" y1="541.075" y2="541.075"
										gradientUnits="userSpaceOnUse">
										<stop offset=".25" stop-color="#FF2626" />
										<stop offset=".25" />
									</linearGradient>
									<linearGradient id="e" x1="1232" x2="160" y1="521" y2="521"
										gradientUnits="userSpaceOnUse">
										<stop />
										<stop offset="1" stop-opacity="0" />
									</linearGradient>
									<linearGradient id="g" x1="626" x2="208" y1="754" y2="754"
										gradientUnits="userSpaceOnUse">
										<stop />
										<stop offset="1" stop-opacity="0" />
									</linearGradient>
									<linearGradient id="h" x1="636" x2="193" y1="44" y2="44"
										gradientUnits="userSpaceOnUse">
										<stop />
										<stop offset="1" stop-opacity="0" />
									</linearGradient>
									<linearGradient id="i" x1="1380" x2="1028" y1="419" y2="419"
										gradientUnits="userSpaceOnUse">
										<stop />
										<stop offset="1" stop-opacity="0" />
									</linearGradient>
									<linearGradient id="j" x1="1362" x2="1156" y1="273" y2="279"
										gradientUnits="userSpaceOnUse">
										<stop />
										<stop offset="1" stop-opacity="0" />
									</linearGradient>
						...
						<span class="astrobear">
							...
							<svg aria-hidden=true xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 316 432">
								...
								<path fill="#fff" fill-rule="evenodd"
									...
									clip-rule="evenodd" />
								<path fill="url(#bb)" fill-opacity=".5" fill-rule="evenodd"
									d="M267.721 234.712C241.49 266.061 202.073 286 158 286c-43.749 0-82.91-19.647-109.141-50.598-11.328-8.104-27.18-7.069-37.353 3.104-11.325 11.325-11.325 29.687 0 41.012l44.548 44.548A28.99 28.99 0 0 0 63 329.203V407c0 12.15 9.85 22 22 22h44c12.15 0 22-9.85 22-22v-28.517c2.123.341 4.293.517 6.5.517 2.555 0 5.06-.236 7.5-.69V407c0 12.15 9.85 22 22 22h44c12.15 0 22-9.85 22-22V328.972a29.004 29.004 0 0 0 6.518-4.906l44.548-44.548c11.325-11.325 11.325-29.687 0-41.012-9.875-9.875-25.099-11.139-36.345-3.794Z"
									clip-rule="evenodd" />
								<path fill="#000"
								...
								<defs>
									<linearGradient id="aa" x1="158" x2="158" y1="0" y2="286"
										gradientUnits="userSpaceOnUse">
										<stop offset=".219" />
										<stop offset="1" stop-color="#fff" />
									</linearGradient>
									<linearGradient id="bb" x1="254" x2="100" y1="419" y2="325"
										gradientUnits="userSpaceOnUse">
										<stop stop-opacity=".98" />
										<stop offset="1" stop-opacity="0" />
									</linearGradient>
									<radialGradient id="cc" cx="0" cy="0" r="1"
  ...
  if (oldToggle) {
    // 保存旧按钮的父元素
    const parentElement = oldToggle.parentElement;
    
    // 创建新按钮元素
    const tempContainer = document.createElement('div');
    tempContainer.innerHTML = toggleButtonHTML;
    const newToggle = tempContainer.firstElementChild;
    
    // 将新按钮替换旧按钮
    if (parentElement) {
      parentElement.replaceChild(newToggle, oldToggle);
    } else {
      // 如果找不到父元素，直接添加到body
  ...
  // 获取新的主题切换按钮 - 使用正确的选择器
  const themeToggle = document.querySelector('.theme-container .toggle');
  ...
  if (themeContainer) {
    themeContainer.setAttribute('data-dark-mode', isDark);
  }
  ...
  function adjustForScreenSize() {
    // 按钮样式现在完全由CSS控制，不需要JavaScript设置
    // CSS中的响应式设计会自动处理不同屏幕尺寸
  }
  ...
  themeToggle.addEventListener('click', function() {
    ...
    // 更新主题容器的状态
    if (themeContainer) {
      themeContainer.setAttribute('data-dark-mode', newPressed);
    }
    
    // 执行主题切换逻辑
    const newTheme = newPressed ? 'dark' : 'light';
    
    // 设置根元素的属性
    document.documentElement.setAttribute('data-dark-mode', newPressed);
    ...
    if (metaThemeColor) {
      metaThemeColor.setAttribute("content", newTheme === 'dark' ? '#121212' : '#f8f8f8');
    }
